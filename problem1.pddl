(define (problem cleanFirstFloor) (:domain officeCleaner)
(:objects
	box1 box2
...
(:init
		(robot-location office4) (box-location box1 office5) (box-location box2 office6)
...
(:goal (and
		(robot-location office9) (box-location box1 office8) (box-location box2 office6)
